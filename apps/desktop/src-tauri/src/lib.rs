...
fn prevent_default() -> tauri::plugin::TauriPlugin<tauri::Wry> {
    ...
    tauri_plugin_prevent_default::Builder::new()
        .with_flags(Flags::keyboard().intersection(Flags::debug()))
        .build()
}
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_tool_groups,
            commands::set_tool_groups,
            ...
            commands::api_write,
            commands::api_remove,
            commands::api_env_read,
            commands::api_env_write,
            commands::api_env_remove,
            commands::api_send,
