...
export const es: Messages = {
  ...
  settings: {
    ...
    background: "Fondo",
    backgroundHint: "Deja que el escritorio se vea a través de la ventana.",
    backgroundSolid: "Sólido",
    backgroundChrome: "Marco",
    backgroundFull: "Completo",
    opacity: "Opacidad",
    opacityHint: "Cuánto dejan pasar las superficies translúcidas.",
    material: "Material",
    materialHint: "Cuánto desenfoca macOS lo que hay detrás de la ventana.",
    materialSubtle: "Sutil",
    materialMedium: "Medio",
    materialDeep: "Profundo",
