...
export const es: Messages = {
  ...
  "resources.cores": "{count} núcleos",
  "resources.bySession": "Por sesión",
  "resources.sessionSummary": "{count} sesiones · {memory} · {cpu}% CPU · {processes} procesos",
  "resources.processCount": "{count} procs",
  "resources.moreProcesses": "+{count} más",
  "resources.noSessions": "No hay sesiones corriendo.",
  "resources.noSessionsHint": "Arrancá una para ver CPU y memoria acá.",
