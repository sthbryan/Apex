export const en = {
  ...
  settings: {
    ...
    providerAdd: "Add",
    providerMore: "Add a provider…",
    providerWhich: "Which one",
    providerOwn: "An endpoint of your own",
    providerName: "Name",
    providerNameHint: "Apex will file it as {name}",
  ...
  acp: {
    ...
    stop: "Stop",
    queued: "queued",
    unqueue: "Take it out of the queue",
    queueIt: "Queue",
    hintQueue: "the agent is busy \u00b7 \u21b5 queues it for when it is done",
    own: "Other",
