export const en = {
  ...
  settings: {
    ...
    backgroundHint: "Let the desktop show through the window.",
    backgroundSolid: "Solid",
    backgroundChrome: "Chrome",
    backgroundFull: "Full",
    opacity: "Opacity",
    opacityHint: "How much the translucent surfaces let through.",
    material: "Material",
    materialHint: "How deeply macOS blurs what sits behind the window.",
    materialSubtle: "Subtle",
    materialMedium: "Medium",
    materialDeep: "Deep",
    uiScale: "Text size",
